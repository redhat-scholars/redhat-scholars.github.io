...
In this introductory workshop, you’ll learn how to use Red Hat OpenShift Data Science to recognize license plates in car pictures, and extract the number from this plate. +
 +
