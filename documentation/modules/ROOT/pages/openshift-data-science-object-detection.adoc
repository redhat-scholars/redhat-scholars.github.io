...
*Tutorial*: link:https://dn.dev/rhods-tutorial[dn.dev/rhods-tutorial,window=_blank]

*Slides*: link:https://dn.dev/rhods-workshop[dn.dev/rhods-workshop,window=_blank]
...
In this introductory workshop, you’ll learn how to use Red Hat OpenShift Data Science and use an object detection model in several different ways.+
